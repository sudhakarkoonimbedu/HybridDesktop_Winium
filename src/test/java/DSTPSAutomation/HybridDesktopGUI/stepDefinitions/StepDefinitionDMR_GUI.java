...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_DMR_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionDMR_GUI {
	...
	public GUI_DMR_LandingPage_Steps gui_DMR_LandingPage_Steps;
	
	public StepDefinitionDMR_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_DMR_LandingPage_Steps  = new GUI_DMR_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_dmr_main_details() throws Throwable{		
		gui_DMR_LandingPage_Steps.verifyDMRDetails();		
	}
	
	@And("^Click on Close button in DMR Main window$")
	public void click_on_close_button() throws Throwable{
		gui_DMR_LandingPage_Steps.clickOnCloseButton();
	}	
}
