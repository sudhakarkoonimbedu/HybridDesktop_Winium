...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_PharmacyCustomer_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionPharmacyCustomer_GUI {
	...
	public GUI_PharmacyCustomer_LandingPage_Steps gui_PharmacyCustomer_LandingPage_Steps;
	
	public StepDefinitionPharmacyCustomer_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_PharmacyCustomer_LandingPage_Steps  = new GUI_PharmacyCustomer_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_pharmacy_customer_details() throws Throwable{		
		gui_PharmacyCustomer_LandingPage_Steps.verifyPharmacyCustomerDetails();		
	}
	
	@And("^Click on Cancel button in Customer Pharmacy Search window$")
	public void click_on_cancel_button() throws Throwable{
		gui_PharmacyCustomer_LandingPage_Steps.clickOnCancelButton();
	}	
}
