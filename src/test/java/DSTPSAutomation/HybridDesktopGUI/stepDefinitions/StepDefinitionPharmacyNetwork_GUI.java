...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_PharmacyNetwork_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionPharmacyNetwork_GUI {
	...
	public GUI_PharmacyNetwork_LandingPage_Steps gui_PharmacyNetwork_LandingPage_Steps;
	
	public StepDefinitionPharmacyNetwork_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_PharmacyNetwork_LandingPage_Steps  = new GUI_PharmacyNetwork_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_pharmacy_network_details() throws Throwable{		
		gui_PharmacyNetwork_LandingPage_Steps.verifyPharmacyNetworkDetails();		
	}
	...
	public void click_on_cancel_button() throws Throwable{
		gui_PharmacyNetwork_LandingPage_Steps.clickOnCancelButton();
	}	
}
