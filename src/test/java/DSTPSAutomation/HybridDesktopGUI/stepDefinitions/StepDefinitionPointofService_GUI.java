...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_PointofService_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionPointofService_GUI {
	...
	public GUI_PointofService_LandingPage_Steps gui_PointofService_LandingPage_Steps;
	
	public StepDefinitionPointofService_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_PointofService_LandingPage_Steps  = new GUI_PointofService_LandingPage_Steps(SharedResource, utils,guiutils);
	}
	...
	public void verify_pos_main_details() throws Throwable{		
		gui_PointofService_LandingPage_Steps.verifyPointofServiceDetails();		
	}
	
	@And("^Click on Cancel button in POS Main window$")
	public void click_on_cancel_button() throws Throwable{
		gui_PointofService_LandingPage_Steps.clickOnCancelButton();
	}	
}
