...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_PharmacyFinancial_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionPharmacyFinancial_GUI {
	...
	public GUI_PharmacyFinancial_LandingPage_Steps gui_PharmacyFinancial_LandingPage_Steps;
	
	public StepDefinitionPharmacyFinancial_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_PharmacyFinancial_LandingPage_Steps  = new GUI_PharmacyFinancial_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_pharmacy_financial_balance_Inquiry_details() throws Throwable{		
		gui_PharmacyFinancial_LandingPage_Steps.verifyPharmacyFinancialDetails();		
	}
	...
	public void click_on_cancel_button() throws Throwable{
		gui_PharmacyFinancial_LandingPage_Steps.clickOnCancelButton();
	}	
}
