...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_PaymentHistoryInquiry_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionPaymentHistoryInquiry_GUI {
	...
	public GUI_PaymentHistoryInquiry_LandingPage_Steps gui_PaymentHistoryInquiry_LandingPage_Steps;
	
	public StepDefinitionPaymentHistoryInquiry_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_PaymentHistoryInquiry_LandingPage_Steps  = new GUI_PaymentHistoryInquiry_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_payment_history_inquiry_details() throws Throwable{		
		gui_PaymentHistoryInquiry_LandingPage_Steps.verifyPaymentHistoryInquiryDetails();		
	}
	
	@And("^Click on Cancel button in Payment History Search window$")
	public void click_on_cancel_button() throws Throwable{
		gui_PaymentHistoryInquiry_LandingPage_Steps.clickOnCancelButton();
	}	
}
