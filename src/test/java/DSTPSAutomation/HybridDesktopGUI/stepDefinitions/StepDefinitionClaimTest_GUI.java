...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_ClaimTest_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionClaimTest_GUI {
	...
	public GUI_ClaimTest_LandingPage_Steps gui_ClaimTest_LandingPage_Steps;
	
	public StepDefinitionClaimTest_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_ClaimTest_LandingPage_Steps  = new GUI_ClaimTest_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_claim_test_main_details() throws Throwable{		
		gui_ClaimTest_LandingPage_Steps.verifyClaimTestDetails();		
	}
	
	@And("^Click on Cancel button in Claim Test Main window$")
	public void click_on_cancel_button() throws Throwable{
		gui_ClaimTest_LandingPage_Steps.clickOnCancelButton();
	}	
}
