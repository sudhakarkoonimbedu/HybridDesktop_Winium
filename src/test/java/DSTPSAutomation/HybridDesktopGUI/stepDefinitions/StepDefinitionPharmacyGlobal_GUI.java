...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_PharmacyGlobal_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionPharmacyGlobal_GUI {
	...
	public GUI_PharmacyGlobal_LandingPage_Steps gui_PharmacyGlobal_LandingPage_Steps;
	
	public StepDefinitionPharmacyGlobal_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_PharmacyGlobal_LandingPage_Steps  = new GUI_PharmacyGlobal_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_pharmacy_global_details() throws Throwable{		
		gui_PharmacyGlobal_LandingPage_Steps.verifyPharmacyGlobalDetails();		
	}
	
	@And("^Click on Cancel button in Pharmacy Address Maintenance window$")
	public void click_on_cancel_button() throws Throwable{
		gui_PharmacyGlobal_LandingPage_Steps.clickOnCancelButton();
	}	
}
