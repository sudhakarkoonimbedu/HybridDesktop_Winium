...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_Client_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionClient_GUI {
	...
	public GUI_Client_LandingPage_Steps gui_Client_LandingPage_Steps;
	
	public StepDefinitionClient_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_Client_LandingPage_Steps  = new GUI_Client_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_client_main_details() throws Throwable{		
		gui_Client_LandingPage_Steps.verifyClientDetails();		
	}
	
	@And("^Click on Cancel button in Client Main window$")
	public void click_on_cancel_button() throws Throwable{
		gui_Client_LandingPage_Steps.clickOnCancelButton();
	}	
}
