...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_Deductible_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionDeductible_GUI {
	...
	public GUI_Deductible_LandingPage_Steps gui_Deductible_LandingPage_Steps;
	
	public StepDefinitionDeductible_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_Deductible_LandingPage_Steps  = new GUI_Deductible_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_deductible_details() throws Throwable{		
		gui_Deductible_LandingPage_Steps.verifyDeductibleDetails();		
	}
	
	@And("^Click on Cancel button in Deductible Main window$")
	public void click_on_cancel_button() throws Throwable{
		gui_Deductible_LandingPage_Steps.clickOnCancelButton();
	}	
}
