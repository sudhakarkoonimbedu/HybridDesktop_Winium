...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_PrescriberRecords_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionPrescriberRecords_GUI {
	...
	public GUI_PrescriberRecords_LandingPage_Steps gui_PrescriberRecords_LandingPage_Steps;
	
	public StepDefinitionPrescriberRecords_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_PrescriberRecords_LandingPage_Steps  = new GUI_PrescriberRecords_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_prescriber_main_details() throws Throwable{		
		gui_PrescriberRecords_LandingPage_Steps.verifyPrescriberRecordsDetails();		
	}
	
	@And("^Click on Close button in Prescriber Main window$")
	public void click_on_close_button() throws Throwable{
		gui_PrescriberRecords_LandingPage_Steps.clickOnCloseButton();
	}	
}
