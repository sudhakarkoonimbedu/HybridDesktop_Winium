...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_GroupRecord_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionGroupRecord_GUI {
	...
	public GUI_GroupRecord_LandingPage_Steps gui_GroupRecord_LandingPage_Steps;
	
	public StepDefinitionGroupRecord_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_GroupRecord_LandingPage_Steps  = new GUI_GroupRecord_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_group_search_details() throws Throwable{		
		gui_GroupRecord_LandingPage_Steps.verifyGroupRecordDetails();		
	}
	
	@And("^Click on Cancel button in Group Search window$")
	public void click_on_cancel_button() throws Throwable{
		gui_GroupRecord_LandingPage_Steps.clickOnCancelButton();
	}	
}
