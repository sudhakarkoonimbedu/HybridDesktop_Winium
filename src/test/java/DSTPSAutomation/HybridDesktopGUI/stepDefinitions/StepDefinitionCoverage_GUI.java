...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_Coverage_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionCoverage_GUI {
	...
	public GUI_Coverage_LandingPage_Steps gui_Coverage_LandingPage_Steps;
	
	public StepDefinitionCoverage_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_Coverage_LandingPage_Steps  = new GUI_Coverage_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_coverage_details() throws Throwable{		
		gui_Coverage_LandingPage_Steps.verifyCoverageDetails();		
	}
	
	@And("^Click on Cancel button in Coverage Main window$")
	public void click_on_cancel_button() throws Throwable{
		gui_Coverage_LandingPage_Steps.clickOnCancelButton();
	}	
}
