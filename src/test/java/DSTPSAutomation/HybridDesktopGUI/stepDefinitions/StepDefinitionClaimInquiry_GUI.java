...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_ClaimInquiry_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionClaimInquiry_GUI {
	...
	public GUI_ClaimInquiry_LandingPage_Steps gui_ClaimInquiry_LandingPage_Steps;
	
	public StepDefinitionClaimInquiry_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_ClaimInquiry_LandingPage_Steps  = new GUI_ClaimInquiry_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_claim_main_details() throws Throwable{		
		gui_ClaimInquiry_LandingPage_Steps.verifyClaimInquiryDetails();		
	}
	
	@And("^Click on Cancel button in Claim Main window$")
	public void click_on_cancel_button() throws Throwable{
		gui_ClaimInquiry_LandingPage_Steps.clickOnCancelButton();
	}	
}
