...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_Pharmacy_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionPharmacy_GUI {
	...
	public GUI_Pharmacy_LandingPage_Steps gui_Pharmacy_LandingPage_Steps;
	
	public StepDefinitionPharmacy_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_Pharmacy_LandingPage_Steps  = new GUI_Pharmacy_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_pharmacy_network_details() throws Throwable{		
		gui_Pharmacy_LandingPage_Steps.verifyPharmacyDetails();		
	}
	...
	public void click_on_cancel_button() throws Throwable{
		gui_Pharmacy_LandingPage_Steps.clickOnCancelButton();
	}	
}
