...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_MemberRecord_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionMemberRecord_GUI {
	...
	public GUI_MemberRecord_LandingPage_Steps gui_MemberRecord_LandingPage_Steps;
	
	public StepDefinitionMemberRecord_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_MemberRecord_LandingPage_Steps  = new GUI_MemberRecord_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_member_main_details() throws Throwable{		
		gui_MemberRecord_LandingPage_Steps.verifyMemberRecordDetails();		
	}
	
	@And("^Click on Cancel button in Member Main window$")
	public void click_on_cancel_button() throws Throwable{
		gui_MemberRecord_LandingPage_Steps.clickOnCancelButton();
	}	
}
