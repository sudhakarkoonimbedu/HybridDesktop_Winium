...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_DeductiblePlan_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionDeductiblePlan_GUI {
	...
	public GUI_DeductiblePlan_LandingPage_Steps gui_DeductiblePlan_LandingPage_Steps;
	
	public StepDefinitionDeductiblePlan_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_DeductiblePlan_LandingPage_Steps  = new GUI_DeductiblePlan_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_deductible_plan_details() throws Throwable{		
		gui_DeductiblePlan_LandingPage_Steps.verifyDeductiblePlanDetails();		
	}
	
	@And("^Click on Cancel button in Deductible Plan Main window$")
	public void click_on_cancel_button() throws Throwable{
		gui_DeductiblePlan_LandingPage_Steps.clickOnCancelButton();
	}	
}
