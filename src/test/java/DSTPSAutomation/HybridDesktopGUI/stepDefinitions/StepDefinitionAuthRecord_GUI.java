...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_AuthRecord_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionAuthRecord_GUI {
	...
	public GUI_AuthRecord_LandingPage_Steps gui_AuthRecord_LandingPage_Steps;
	
	public StepDefinitionAuthRecord_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_AuthRecord_LandingPage_Steps  = new GUI_AuthRecord_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_authorization_main_details() throws Throwable{		
		gui_AuthRecord_LandingPage_Steps.verifyAuthRecordDetails();		
	}
	
	@And("^Click on Cancel button in Authorization Main window$")
	public void click_on_cancel_button() throws Throwable{
		gui_AuthRecord_LandingPage_Steps.clickOnCancelButton();
	}	
}
