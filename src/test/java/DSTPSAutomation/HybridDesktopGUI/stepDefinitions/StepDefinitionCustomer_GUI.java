...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_Customer_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionCustomer_GUI {
	...
	public GUI_Customer_LandingPage_Steps gui_Customer_LandingPage_Steps;
	
	public StepDefinitionCustomer_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_Customer_LandingPage_Steps  = new GUI_Customer_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_customer_main_details() throws Throwable{		
		gui_Customer_LandingPage_Steps.verifyCustomerDetails();		
	}
	
	@And("^Click on Cancel button in Customer Main window$")
	public void click_on_cancel_button() throws Throwable{
		gui_Customer_LandingPage_Steps.clickOnCancelButton();
	}	
}
