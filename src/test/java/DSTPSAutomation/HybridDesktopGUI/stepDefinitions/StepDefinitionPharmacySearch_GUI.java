...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_PharmacySearch_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionPharmacySearch_GUI {
	...
	public GUI_PharmacySearch_LandingPage_Steps gui_PharmacySearch_LandingPage_Steps;
	
	public StepDefinitionPharmacySearch_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_PharmacySearch_LandingPage_Steps  = new GUI_PharmacySearch_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_pharmacy_search_details() throws Throwable{		
		gui_PharmacySearch_LandingPage_Steps.verifyPharmacySearchDetails();		
	}
	
	@And("^Click on Cancel button in Pharmacy Search window$")
	public void click_on_cancel_button() throws Throwable{
		gui_PharmacySearch_LandingPage_Steps.clickOnCancelButton();
	}	
}
