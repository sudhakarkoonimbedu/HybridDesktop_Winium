...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_PlanlistBrowse_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionPlanlistBrowse_GUI {
	...
	public GUI_PlanlistBrowse_LandingPage_Steps gui_PlanlistBrowse_LandingPage_Steps;
	
	public StepDefinitionPlanlistBrowse_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_PlanlistBrowse_LandingPage_Steps  = new GUI_PlanlistBrowse_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_browse_details() throws Throwable{		
		gui_PlanlistBrowse_LandingPage_Steps.verifyPlanlistBrowseDetails();		
	}
}
