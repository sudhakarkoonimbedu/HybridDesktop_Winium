...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_PlanlistCostPlan_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionPlanlistCostPlan_GUI {
	...
	public GUI_PlanlistCostPlan_LandingPage_Steps gui_PlanlistCostPlan_LandingPage_Steps;
	
	public StepDefinitionPlanlistCostPlan_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_PlanlistCostPlan_LandingPage_Steps  = new GUI_PlanlistCostPlan_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_cost_plan_details() throws Throwable{		
		gui_PlanlistCostPlan_LandingPage_Steps.verifyPlanlistCostPlanDetails();		
	}
}
