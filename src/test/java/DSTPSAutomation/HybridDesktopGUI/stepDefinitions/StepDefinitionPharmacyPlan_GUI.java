...
import DSTPSAutomation.HybridDesktopGUI.steps.GUI_PharmacyPlan_LandingPage_Steps;
import cucumber.api.java.en.And;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class StepDefinitionPharmacyPlan_GUI {
	...
	public GUI_PharmacyPlan_LandingPage_Steps gui_PharmacyPlan_LandingPage_Steps;
	
	public StepDefinitionPharmacyPlan_GUI(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils, HybridDesktop_GUI_Utility guiutils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		gui_PharmacyPlan_LandingPage_Steps  = new GUI_PharmacyPlan_LandingPage_Steps(SharedResource, utils,guiutils);
	}
...
//	}	
	...
	public void verify_pharmacy_plan_maintenance_details() throws Throwable{		
		gui_PharmacyPlan_LandingPage_Steps.verifyPharmacyPlanDetails();		
	}
	
	@And("^Click on Cancel button in Pharmacy Plan Maintenance window$")
	public void click_on_cancel_button() throws Throwable{
		gui_PharmacyPlan_LandingPage_Steps.clickOnCancelButton();
	}	
}
