...
@CucumberOptions(
		features = {"classpath:features/HybridDesktopGUI/PlanlistBrowse_GUI.feature" }, 
			tags = {"@SmokeTest"}, 
			...
			plugin =  {"pretty","html:target/html", "json:planlistbrowse.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class PlanlistBrowseFeature_TestRunner extends AbstractTestNGCucumberTests {
