...
@CucumberOptions(
		features = {"classpath:features/HybridDesktopGUI/PharmacyPlan_GUI.feature" }, 
			tags = {"@SmokeTest"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacyplan.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class PharmacyPlanFeature_TestRunner extends AbstractTestNGCucumberTests {
