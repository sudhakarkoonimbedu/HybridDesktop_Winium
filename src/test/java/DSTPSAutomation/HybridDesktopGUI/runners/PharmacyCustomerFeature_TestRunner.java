...
@CucumberOptions(
		features = {"classpath:features/HybridDesktopGUI/PharmacyCustomer_GUI.feature" }, 
			tags = {"@SmokeTest"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacycustomer.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class PharmacyCustomerFeature_TestRunner extends AbstractTestNGCucumberTests {
