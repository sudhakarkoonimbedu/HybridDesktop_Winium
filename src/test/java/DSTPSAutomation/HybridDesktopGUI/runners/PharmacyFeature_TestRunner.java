...
@CucumberOptions(
		features = {"classpath:features/HybridDesktopGUI/Pharmacy_GUI.feature" }, 
			tags = {"@SmokeTest"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacy.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class PharmacyFeature_TestRunner extends AbstractTestNGCucumberTests {
