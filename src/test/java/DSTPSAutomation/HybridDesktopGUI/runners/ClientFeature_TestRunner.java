...
@CucumberOptions(
		features = {"classpath:features/HybridDesktopGUI/Client_GUI.feature" }, 
			tags = {"@SmokeTest"}, 
			...
			plugin =  {"pretty","html:target/html", "json:client.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class ClientFeature_TestRunner extends AbstractTestNGCucumberTests {
