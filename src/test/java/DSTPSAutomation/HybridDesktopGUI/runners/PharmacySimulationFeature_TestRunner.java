...
@CucumberOptions(
		features = {"classpath:features/HybridDesktopGUI/PharmacySimulation_GUI.feature" }, 
			tags = {"@SmokeTest"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacysimulation.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class PharmacySimulationFeature_TestRunner extends AbstractTestNGCucumberTests {
