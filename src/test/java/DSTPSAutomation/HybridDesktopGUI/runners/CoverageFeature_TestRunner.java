...
@CucumberOptions(
		features = {"classpath:features/HybridDesktopGUI/Coverage_GUI.feature" }, 
			tags = {"@SmokeTest"}, 
			...
			plugin =  {"pretty","html:target/html", "json:coverage.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class CoverageFeature_TestRunner extends AbstractTestNGCucumberTests {
