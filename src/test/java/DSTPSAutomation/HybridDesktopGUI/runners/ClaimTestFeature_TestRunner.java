...
@CucumberOptions(
		features = {"classpath:features/HybridDesktopGUI/ClaimTest_GUI.feature" }, 
			tags = {"@SmokeTest"}, 
			...
			plugin =  {"pretty","html:target/html", "json:claimtest.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class ClaimTestFeature_TestRunner extends AbstractTestNGCucumberTests {
