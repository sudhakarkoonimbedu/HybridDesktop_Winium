...
@CucumberOptions(
		features = {"classpath:features/HybridDesktopGUI/DMR_GUI.feature" }, 
			tags = {"@SmokeTest"}, 
			...
			plugin =  {"pretty","html:target/html", "json:dmr.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class DMRFeature_TestRunner extends AbstractTestNGCucumberTests {
