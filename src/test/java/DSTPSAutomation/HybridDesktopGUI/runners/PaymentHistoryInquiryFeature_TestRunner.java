...
@CucumberOptions(
		features = {"classpath:features/HybridDesktopGUI/PaymentHistoryInquiry_GUI.feature" }, 
			tags = {"@SmokeTest"}, 
			...
			plugin =  {"pretty","html:target/html", "json:paymenthistoryinquiry.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class PaymentHistoryInquiryFeature_TestRunner extends AbstractTestNGCucumberTests {
