...
@CucumberOptions(
		features = {"classpath:features/HybridDesktopGUI/GroupRecord_GUI.feature" }, 
			tags = {"@SmokeTest"}, 
			...
			plugin =  {"pretty","html:target/html", "json:grouprecord.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class GroupRecordFeature_TestRunner extends AbstractTestNGCucumberTests {
