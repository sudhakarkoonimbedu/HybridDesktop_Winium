...
@CucumberOptions(
		features = {"classpath:features/HybridDesktopGUI/PharmacySearch_GUI.feature" }, 
			tags = {"@SmokeTest"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacysearch.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class PharmacySearchFeature_TestRunner extends AbstractTestNGCucumberTests {
