...
@CucumberOptions(
		features = {"classpath:features/HybridDesktopGUI/PharmacyGlobal_GUI.feature" }, 
			tags = {"@SmokeTest"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacyglobal.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class PharmacyGlobalFeature_TestRunner extends AbstractTestNGCucumberTests {
