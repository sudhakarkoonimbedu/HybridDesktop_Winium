...
@CucumberOptions(
		features = {"classpath:features/HybridDesktopGUI/DeductiblePlan_GUI.feature" }, 
			tags = {"@SmokeTest"}, 
			...
			plugin =  {"pretty","html:target/html", "json:deductibleplan.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class DeductiblePlanFeature_TestRunner extends AbstractTestNGCucumberTests {
