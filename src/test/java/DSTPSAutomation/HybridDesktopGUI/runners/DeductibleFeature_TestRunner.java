...
@CucumberOptions(
		features = {"classpath:features/HybridDesktopGUI/Deductible_GUI.feature" }, 
			tags = {"@SmokeTest"}, 
			...
			plugin =  {"pretty","html:target/html", "json:deductible.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class DeductibleFeature_TestRunner extends AbstractTestNGCucumberTests {
