...
@CucumberOptions(
		features = {"classpath:features/HybridDesktopGUI/PharmacyFinancial_GUI.feature" }, 
			tags = {"@SmokeTest"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacyfinancial.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class PharmacyFinancialFeature_TestRunner extends AbstractTestNGCucumberTests {
